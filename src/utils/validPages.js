...
module.exports = [
  ...
  { path: "/excel", file: "data_excel", book: "Excel", full: true },
  { path: "/data_excel", file: "data_excel", book: "Excel", full: false },
  { path: "/formation", file: "data_formation", full: true },
  { path: "/data_formation", file: "data_formation", full: false },
  { path: "/outlook", file: "data_outlook", book: "Outlook", full: true },
  { path: "/data_outlook", file: "data_outlook", book: "Outlook", full: false },
  ...
  { path: "/powerpoint", file: "data_powerpoint", book: "PowerPoint", full: true },
  { path: "/data_powerpoint", file: "data_powerpoint", book: "PowerPoint", full: false },
  { path: "/service", file: "data_service", full: true },
  { path: "/data_service", file: "data_service", full: false },
  { path: "/word", file: "data_word", book: "Word", full: true },
  { path: "/data_word", file: "data_word", book: "Word", full: false },
];
