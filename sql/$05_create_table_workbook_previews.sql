...
# create the workbook_previews table
CREATE TABLE workbook_previews
(
...
# populate the workbook_previews table
INSERT INTO workbook_previews(workbook_id, description, path, level) VALUES
(@word_base_id, 'Le contrôle de l’environnement de travail', '1', 1),
...
INSERT INTO workbook_previews(workbook_id, description, path, level) VALUES
(@word_inter_id, 'Les tableaux', '1', 1),
...
INSERT INTO workbook_previews(workbook_id, description, path, level) VALUES
(@word_adv_id, 'Les signets, les notes de bas de page, les renvois, les hyperliens', '1', 1),
...
INSERT INTO workbook_previews(workbook_id, description, path, level) VALUES
(@excel_base_id, 'Le contrôle de l’environnement de travail', '1', 1),
...
INSERT INTO workbook_previews(workbook_id, description, path, level) VALUES
(@excel_inter_id, 'Les fonctions prédéfinies', '1', 1),
...
INSERT INTO workbook_previews(workbook_id, description, path, level) VALUES
(@excel_adv_id, 'Les tableaux croisés dynamiques', '1', 1),
